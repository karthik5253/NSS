                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-6">
                     ...
                     <a  href="https://twitter.com/nss_sju?t=Min8W5Um4PHO6hd2ss-Qvw&s=08" ><i class="fab fa-twitter">
                
                </i></a></a>
                        </button>
                        <button class="btn btn-just-icon ">
                        <a  href=" https://www.facebook.com/groups/216085148408611/?ref=share">
            <i class="fab fa-facebook-f"></i></a>                        </button>
                        <button class="btn btn-just-icon btn-default">
                        <a  href="https://instagram.com/n.s.s__sjub?igshid=YmMyMTA2M2Y=">   <i class="fab fa-instagram"></i></a>
                        </button>
                    </div>
