 <nav class="navbar navbar-expand-lg fixed-top nav-down">
  ...
  <img src="assets/image/nss/SJU-logo.jpg"   width="145px" height="80px" alt="Circle Image" class="img-circle img-responsive">   
        </a>
    ...
    <div class="container">
      <div class="navbar-translate">
        ...
        <a class="navbar-brand" href="index.php" rel="tooltip" title="Paper Kit 2 PRO" data-placement="bottom" >
         <b>St. Joseph's University</b> <br><small> National Service Scheme</small>
        </a>
